...
public:
  ...
  // Generate diff expression relocations. Note that if the relax feature is not
  // enabled, it may be safe for the assembler to calculate these internally,
  // but that requires more logic in RISCVAsmParser.
